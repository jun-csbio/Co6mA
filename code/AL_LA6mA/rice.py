...
# def rice_data(pos,neg):
#     pos, neg = readseq(pos,neg)
#     data=pos+neg
#     target = [1] * len(pos) + [0] * len(neg)
#     x_trainval, x_test, y_trainval, y_test = train_test_split(data, target, random_state=42,test_size=1.0/8)
#     x_train, x_val, y_train, y_val = train_test_split(x_trainval, y_trainval, random_state=42, test_size=1.0/ 8)
...
#x_train,x_val,x_test,y_train,y_val,y_test =rice_data("D:\课题/6mA\Deep6mA-master\data/rice\shuffle_pos.txt", "D:\课题/6mA\Deep6mA-master\data/rice\shuffle_neg.txt")